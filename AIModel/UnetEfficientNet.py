...
from AIModel.modelDropOut import *
from AIModel.metrics import  dice,IU,recall,precision,f1,specificity
from AIModel.losses import bce_dice_loss
import cv2
import numpy as np
class UnetEfficientNet():
    ...
    def predict_video(self,input_path,output_path):
        ...
        fps = str(video_inp.get(cv2.CAP_PROP_FPS))+'/1'
        video_out=skvideo.io.FFmpegWriter(output_path, inputdict={
        '-r': fps,
        },
        outputdict={
        '-vcodec': 'libx264',
